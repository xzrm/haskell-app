...
/* package sqlite-simple-errors-0.2.0.0 */
#ifndef VERSION_sqlite_simple_errors
#define VERSION_sqlite_simple_errors "0.2.0.0"
#endif /* VERSION_sqlite_simple_errors */
#ifndef MIN_VERSION_sqlite_simple_errors
#define MIN_VERSION_sqlite_simple_errors(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_sqlite_simple_errors */
